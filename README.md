...
## Solution 
Having a small application that runs on the client machines and able to request Azure for a firewall rule update wothput human interve will be relieving in terms of support cases.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzAwMjg4MzcsLTc1MjU1NDU0NV19
-->